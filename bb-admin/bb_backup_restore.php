...
$params = array (
		...
		"onclick" => "bb_submit_link('bb-links/bb_backup_restore_link_1.php'); return false;" 
);
$main->echo_script_button ( "backup_database", $params );
$params = array (
		"class" => "spaced",
		"label" => "Backup Files",
		"onclick" => "bb_submit_link('bb-links/bb_backup_restore_link_2.php'); return false;" 
);
...
$main->echo_input ( "encrypt_method", 1, array (
		'type' => "checkbox",
		'class' => "middle spaced",
		'checked' => true 
) );
...
$params = array (
		...
		"onclick" => "bb_submit_link('bb-links/bb_backup_restore_link_3.php'); return false;" 
);
...
$params = array (
		"class" => "spaced",
		"label" => "Download List Definitions",
		"onclick" => "bb_submit_link('bb-links/bb_backup_restore_link_4.php'); return false;" 
);
$main->echo_script_button ( "dump_listdefs", $params );
$params = array (
		"class" => "spaced",
		"label" => "Download List Data",
		"onclick" => "bb_submit_link('bb-links/bb_backup_restore_link_5.php'); return false;" 
);
