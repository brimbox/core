...
$arr_definitions = array('new'=>array('keys'=>array("name","description","archive")),
                         'update'=>array('keys'=>array("name","description","archive"),),
                         'delete'=>array());
...
foreach ($arr_definitions as $key => $value)
    ...
    switch ($key)
        ...
        case "delete":                
            ...
            $main->echo_input ( "confirm_remove_delete", 1, array (
                    'type' => 'checkbox',
