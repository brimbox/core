                    ...
                    if (hash('sha512', $passwd . $salt) == $hash)
                        ...
                        if ($main->post('modules_table_checkbox', $module) == 1)
                            ...
                            for ($i=0; $i<$cnt; $i++)
                                ...
                                $str = rtrim(fgets($handle));
                                $row = explode("\t", decrypt_line($str, $passwd, $iv, $type));
                                $query = "INSERT INTO modules_table (module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, " .
                                         "module_url, standard_module, module_files, module_details, change_date) " .
