...
$query = <<<EOT
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
...
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (1, 'bb-primary/bb_home.php', 'bb_home', 'home', 'Home', 'bb_brimbox', 3, 'Core', 0, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the home landing page for users, superusers, and admins which includes the logout link, basic session stats such as user an database, and space to place customized links and information regarding the database."}'); 
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (2, 'bb-primary/bb_browse.php', 'bb_browse', 'browse', 'Browse', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard browse page for users. It allows users to browse data by choosing the first character of the data in a particular column."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (3, 'bb-primary/bb_lookup.php', 'bb_lookup', 'lookup', 'Lookup', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard lookup page for users. It allows users to browse data by choosing in a particular column by value or part of value."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (4, 'bb-primary/bb_search.php', 'bb_search', 'search', 'Search', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard search page for users. It allows user to search data based on content using boolean expressions."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (5, 'bb-primary/bb_view.php', 'bb_view', 'view', 'View', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard view page used when drilling down into child records."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (6, 'bb-primary/bb_details.php', 'bb_details', 'details', 'Details', 'bb_brimbox', 3,'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard details page used when viewing details of a particular record. It also has functionality for changing the linking of a record."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (7, 'bb-primary/bb_cascade.php', 'bb_cascade', 'cascade', 'Cascade', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard cascade tab used to view a record and all its child records all at once."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (8, 'bb-primary/bb_input.php', 'bb_input', 'input', 'Input', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard input page for inputting data to the database. It checks for keys, required fields, and data validation."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (9, 'bb-primary/bb_queue.php', 'bb_queue', 'queue', 'Queue', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard queue page used for receiving email sent to the database."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (10, 'bb-primary/bb_listview.php', 'bb_listview', 'listview', 'List', 'bb_brimbox', 3, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the standard page for viewing records contained in a list."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (1, 'bb-admin/bb_create_lists.php', 'bb_create_lists', 'create-lists', 'Manage Lists', 'bb_brimbox', 4, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the superuser module used in creating lists by layout type."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (2, 'bb-admin/bb_dropdowns.php', 'bb_dropdowns', 'dropdowns', 'Manage Dropdowns', 'bb_brimbox', 4, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the superuser module used when creating dropdowns for the input page."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (3, 'bb-admin/bb_upload_data.php', 'bb_upload_data', 'upload-data', 'Upload Data', 'bb_brimbox', 4, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used for bulk loads of data to the database."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (4, 'bb-admin/bb_upload_docs.php', 'bb_upload_docs', 'upload-docs', 'Upload Documents', 'bb_brimbox', 4, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used for uploading documents, usually support documents, to the database."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (5, 'bb-admin/bb_query_alias.php', 'bb_query_alias', 'query-alias', 'Query Alias', 'bb_brimbox', 4, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used for constructing SELECT gueries, as would be used in reports."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (1, 'bb-admin/bb_manage_users.php', 'bb_manage_users', 'manage-users', 'Manage Users', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used for managing users and their permissions."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (2, 'bb-admin/bb_manage_log.php', 'bb_manage_log', 'manage-log', 'Manage Log', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used to log certain actions in the database."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (3, 'bb-admin/bb_layout_names.php', 'bb_layout_names', 'layout-names', 'Set Layout Names', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used for setting up layouts and their respective links."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (4, 'bb-admin/bb_column_names.php', 'bb_column_names', 'column-names', 'Set Column Names', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module used for setting up column names, their row and order properties, and their validation values."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (5, 'bb-admin/bb_create_key.php', 'bb_create_key', 'create-key', 'Create Key', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module for defining a key column for unique values."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (6, 'bb-admin/bb_manage_modules.php', 'bb_manage_modules', 'manage-modules', 'Manage Modules', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the admin module for uploading modules and installing program updates."}');
INSERT INTO modules_table(module_order, module_path, module_name, module_slug, friendly_name, interface, module_type, module_version, standard_module, module_files, module_details)
VALUES (7, 'bb-admin/bb_backup_restore.php', 'bb_backup_restore', 'backup-restore', 'Backup and Restore', 'bb_brimbox', 5, 'Core', 6, '', '{"company":"Brimbox","author":"Brimbox Staff","license":"GNU GPL v3","description":"This is the module for backing up, cleansing, and restoring an encrypted brimbox database."}');
EOT;
if ($do_modules_table) {
	$result = pg_query ( $con, $query );
